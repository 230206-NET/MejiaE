...
namespace CoinFlipper {
    public class Flipper {
        public static void Main(string[] args) {
            ...
            string result = coinFaces[random.Next(coinFaces.Length)]; //get a random number between the length of our coinFaces array (between 0 and 1) and use it to get the index value in the array.
